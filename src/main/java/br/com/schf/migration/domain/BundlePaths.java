...
public final class BundlePaths {
    ...
    public static final List<String> DATA_FILES = List.of(
        ORGANIZATIONS, USERS, SUPPLIERS, CATEGORIES, ACCOUNTS, PAYABLES, PAYMENTS);
    public static final List<String> REQUIRED_FILES = List.of(
        MANIFEST, CHECKSUMS, ORGANIZATIONS, USERS, SUPPLIERS, CATEGORIES, ACCOUNTS, PAYABLES, PAYMENTS);
